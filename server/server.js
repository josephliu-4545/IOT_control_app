...
const TRANSLATION_FALLBACKS = {
  ...
  'my': {
    ...
    'motor': 'မော်တာ',
    'fan': 'လေသာယာ',
    'heater': 'အပူရှိန်ပေးစက်',
    'air conditioner': 'လေအေးစက်',
    'refrigerator': 'အအေးစက်',
    'microwave': 'မိုက်ခရိုဝေ့',
    'oven': 'အိုဗင်',
    'stove': 'မီးဖို',
    'sink': 'ရေခံပန်း',
    'toilet': 'အိမ်သာ',
    ...
    'towel': 'တောင်း',
    'soap': 'ဆပ်ပြာ',
    'toothbrush': 'သွားတိုက်စရာ',
    'toothpaste': 'သွားတိုက်ဆေး',
    'comb': 'တောင်ပံ့',
    'brush': 'စုတ်ကြော',
    'mirror': 'မှန်',
    'lipstick': 'အချောင်းလက်ကောက်',
    'makeup': 'အလှဆင်ပစ္စည်း',
    'perfume': 'အမွှေးရည်',
    'jewelry': 'ရတနာပစ္စည်း',
    'ring': 'လက်စွပ်',
    'necklace': 'လည်စွပ်',
    ...
    'pill': 'ဆေးလုံး',
    'bandage': 'ပတ်ကြေး',
    'thermometer': 'အပူချိန်တိုင်း',
    'stethoscope': 'နှလုံးခုနှားကိရိယာ',
    'syringe': 'ဆေးထိုးအိတ်',
    'gloves': 'လက်အိတ်များ',
    'mask': 'မျက်နှာဖုံး',
    'helmet': 'ဦးထုပ်',
    ...
    'wallet': 'ပိုက်ဆံအိတ်',
    'backpack': 'ကျောအိတ်',
    'suitcase': 'လေယာဉ်ပစ္စည်းအိတ်',
    'luggage': 'ခရီးသွားပစ္စည်း',
    'map': 'မြေပုံ',
    'compass': 'ညွှန်ကိရိယာ',
    'telescope': 'တယ်လီစကုပ်',
    'microscope': 'မိုက်ခရိုစကုပ်',
    ...
    'clock': 'နာရီ',
    'watch': 'လက်နာရီ',
    'timer': 'အချိန်တိုင်းကိရိယာ',
    'stopwatch': 'အချိန်တိုင်းနာရီ',
    'alarm': 'စက်ခလုတ်',
    'bell': 'ခေါင်းလောင်း',
    'horn': 'ခရုသင်း',
    'whistle': '�ေခေါင်း',
